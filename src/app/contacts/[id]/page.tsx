					...
					{contact.companies ? (
						<div className="space-y-3">
							...
							<div className="flex flex-wrap gap-2">
								{contact.companies.kundentyp && (
									<Badge variant="secondary">
										{contact.companies.kundentyp.charAt(0).toUpperCase() +
											contact.companies.kundentyp.slice(1)}
									</Badge>
								)}
								{contact.companies.status && (
									<Badge
										className={cn(
											contact.companies.status === "gewonnen" &&
												"bg-emerald-600 text-white",
											contact.companies.status === "lead" &&
												"bg-amber-600 text-white",
											!["gewonnen", "lead"].includes(
												contact.companies.status,
								...
								{contact.companies.wassertyp && (
									<Badge variant="outline">{contact.companies.wassertyp}</Badge>
								)}
							...
							<Button
								variant="outline"
								size="sm"
								onClick={() => setChangeCompanyDialog(true)}
							>
								Change Company
							</Button>
						</div>
